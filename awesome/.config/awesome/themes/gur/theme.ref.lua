...
--theme.font          = "Input Mono Compressed 13"
-- theme.font          = "Rec Mono Linear 10"
theme.font          = "IBM Plex Sans 12"
-- theme.font          = "Fira Code Nerd Font 13"
...
theme.bg_normal     = "#ffffff" .. "ff"
theme.bg_focus      =  "#424874" -- "#DDB6F2"
theme.bg_urgent     = "#ff0000"
theme.bg_minimize   = theme.bg_normal

theme.bg_systray    =  "#D6E5FA"

theme.tasklist_fg_normal	= dark
theme.tasklist_bg_normal	= theme.bg_normal
theme.tasklist_fg_focus	    = dark
theme.tasklist_bg_focus	    = "#DCD6F7"
theme.tasklist_fg_urgent	= theme.bg_urgent
theme.tasklist_bg_urgent	= theme.bg_normal
theme.tasklist_fg_minimize  = "#a8a8a8"
theme.tasklist_bg_minimize  = "#ffffff"


theme.taglist_bg_empty      =   theme.bg_normal
theme.taglist_fg_empty      =   "#444444"
theme.taglist_bg_occupied   =   "#DCD6F7"
theme.taglist_fg_occupied   =   dark
theme.taglist_fg_focus	    =   light
...
-- theme.tasklist_fg_normal	= light
-- theme.tasklist_bg_normal	= theme.bg_normal
-- theme.tasklist_fg_focus	    = light
-- theme.tasklist_bg_focus	    = "#424874"
-- theme.tasklist_fg_urgent	= theme.bg_urgent
-- theme.tasklist_bg_urgent	= theme.bg_normal
-- theme.tasklist_fg_minimize  = dark
-- theme.tasklist_bg_minimize  = "#DCD6F7"
...
theme.wallpaper = themes_path.."default/calm-lake-sunset-nature.jpg"
