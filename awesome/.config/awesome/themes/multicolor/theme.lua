...
theme.font                                      = "Recursive Sn Lnr St 12"
...
function theme.at_screen_connect(s)
    ...
    -- s.mybottomwibox = awful.wibar({ position = "bottom", screen = s, border_width = 0, height = dpi(18), bg = theme.bg_normal, fg = theme.fg_normal })
